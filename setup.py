...
cur.execute('CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT, email STRING, hashed_password STRING);')
cur.execute('INSERT INTO users(email, hashed_password) values(?, ?)', ('user@example.com', hash_password('password')))
conn.commit()
